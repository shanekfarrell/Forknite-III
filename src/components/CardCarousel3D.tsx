                ...
                if (isFrontFace) {
                  ...
                  return (
                    <div
                      ...
                      style={{
                        backgroundColor: fallbackColor || baseBgColor,
                        transform: `translateZ(${zOffset}px)`,
